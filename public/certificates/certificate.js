...
function emailProcess(id) {
  if (!id) {
    alert("Certificate ID missing for email.");
    return;
  }
  ...
  fetch("../../backend/api/certificate.php", { method: "POST", body: formData })
    ...
    .then((data) => {
      ...
      if (data.status === "success") {
        ...
        window.location.href = "../emailEditor/email_editor.html";
      } else {
...
function editProcess(id) {
  if (!id) {
    alert("Certificate ID missing for edit.");
    return;
  }
...
function deleteProcess(id) {
  if (!id) {
    alert("Certificate ID missing for delete.");
    return;
  }
  ...
  item.addEventListener("click", () => {
    ...
    switch (text) {
      ...
      case "Create Templates":
        location.href = "../templates/create_template.html";
        break;
      case "Certificates":
